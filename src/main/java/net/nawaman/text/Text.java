...
import net.nawaman.util.CanBeCharSequence;
...
/** Array of chars */
abstract public class Text implements CharSequence, CanBeCharSequence, DataArray<Character>, Comparable<CharSequence>,
								Objectable, Serializable {
	
	private static final long serialVersionUID = -7974950871966066518L;

	/** Constructs a char array. */
	protected Text() {}
	
	/** Constructs a char array. */
	protected Text(Object pExtraInfo) {
	...
	public CharSequence subSequence(int start, int end) {
		...
		if(this.isStructure())  return new FixedLengthText(this.get(start, end - start));
		if(this.isAppendable()) return new VirtualText(this.asAppendable(), start, end - start);
		if(this.isVirtual())    return new VirtualText(this.asVirtual(), start, end - start);
		return null;
	}
	
	/** Returns the string representation of this char array which is the same with its string value. */ @Override
	final public String toString() {
		// TODO - This is a Hack to avoid '\0' in the string
	...
	// Characteristic +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	/** Checks if this Text contains an actual chars */
	public boolean isActual() {
		return false;
	}

	/** Checks if this Text is an AppendableText */
	public boolean isAppendable() {
		return false;
	}
	/** Returns this Text as an AppendableText */
	public AppendableText asAppendable() {
		return null;
	}

	/** Checks if this Text is a VirtualText */
	public boolean isVirtual() {
		return false;
	}
	/** Returns this Text as a VirtualText */
	public VirtualText asVirtual() {
		return null;
	}

	/** Checks if this Text is a StructureText */
	...
	/** Returns the hexadecimal representation of this Texts in this array */
	...
	/** Detail representation of this text */
	String toDetail(int Offset, int Tab) {
		...
		SB.append(ESB).append(": \"|").append(UString.escapeText(this.getString())).append("|\"");
		return SB.toString();
	}
	/** Detail representation of this text */
	final public String toDetail() {
		return this.toDetail(0, 0);
	}
