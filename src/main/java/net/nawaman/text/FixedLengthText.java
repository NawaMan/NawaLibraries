...
/** Fixed-Length Text */
public class FixedLengthText extends Text {
	
	private static final long serialVersionUID = 1844444232654919423L;

	// Constructor +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

	/** Constructs a FixLengthText of the length pLength */
	public FixedLengthText(int pLength) {
		if (pLength < 0)
			pLength = 0;
		this.Data = new char[pLength];
	}

	/** Constructs a FixLengthText of from char[] */
	public FixedLengthText(char[] pChars) {
		this.Data = pChars;
		this.DLength = (this.Data == null) ? 0 : this.Data.length;
	}

	/** Constructs a FixLengthText of from char[] */
	public FixedLengthText(CharSequence pCS) {
		this(pCS.toString().toCharArray());
	}
	
	/** Constructs a FixLengthText of the length pLength */
	public FixedLengthText(Object pExtraInfo, int pLength) {
		super(pExtraInfo);
		if (pLength < 0)
			pLength = 0;
		this.Data = new char[pLength];
	...
	/** Constructs a FixLengthText of from char[] */
	public FixedLengthText(Object pExtraInfo, char[] pChars) {
		super(pExtraInfo);
		this.Data = pChars;
		this.DLength = (this.Data == null) ? 0 : this.Data.length;
	}
	...
	/** Constructs a FixLengthText of from char[] */
	public FixedLengthText(Object pExtraInfo, CharSequence pCS) {
		this(pExtraInfo, pCS.toString().toCharArray());
	}
